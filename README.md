...
Консольная система на .NET 8 для хранения карт и оптимального подбора колоды при ограничениях на бюджет и размер.
...
1. Укажите строку подключения в `DeckOptimizer.UI/.env`:
